...
declare -a configs=("gerrit-post" "mtk-connect-post" "mtk-connect-post-key" "keycloak-post" "keycloak-post-gerrit" "keycloak-post-jenkins" "keycloak-post-argocd"  "keycloak-post-headlamp" "keycloak-post-grafana" "keycloak-post-mtk-connect" "grafana-post")
