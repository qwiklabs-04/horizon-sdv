...
pipelineJob('Android/Environment/CF Instance Template ARM64') {
  ...
  parameters {
    ...
    stringParam {
      ...
      defaultValue('')
      description('''<p>Optional parameter to define the unique name used for the instance template, e.g.  <i>cuttlefish-vm-instance-test-v1300</i><br/>
        Name must start with <i>cuttlefish-vm</i>, refer to docs for details on regex requirements for name.<br/>
        Default: The name will be automatically derived from ANDROID_CUTTLEFISH_REVISION., e.g. <i>cuttlefish-vm-v1300</i><br/><br/></p>''')
      trim(true)
    }
